    ...
    <section class="mt-5 mb-5">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-sm-3 mb-2">
                    <img class="img-thumbnail" src="{{ asset('/images') }}/{{ $book->image }}"
                        style="width:18.5rem; height:25rem;">
                    <br>
                    <a href="{{ route('book.borrow', $book->id) }}" class="btn btn-primary"> Add a borrower</a>
                </div>
                <div class="col-9 mb-2">
                    <h5 class="fw-bold">{{ $book->bookTitle }} <span
                            class="fw-normal"><small>({{ $book->isbn }})</small></span></h5>
                    <p>by <u>{{ $book->author }}</u></p>
                    <div class="d-flex mb-3">
                        <div class="me-auto p-2"> <span
                                class="badge rounded-pill text-bg-primary float-start">{{ $book->genre }}</span></div>
            ...
            <div class="col-sm-9 offset-sm-3 mb-2">
                ...
                <form method="post" action="{{ route('book.update', $book->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control shadow-none  @error('bookTitle') is-invalid @enderror"
                            value="{{ $book->bookTitle }}" name="bookTitle" id="bookTitle">
                        @error('bookTitle')
                            <small id="helpId" class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control shadow-none  @error('isbn') is-invalid @enderror"
                            value="{{ $book->isbn }}" name="isbn" id="isbn">
                        @error('isbn')
                            <small id="helpId" class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select shadow-none  @error('genre') is-invalid @enderror" name="genre"
                            id="genre">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                            class="form-control shadow-none  @error('synopsis') is-invalid @enderror"
                            value="{{ $book->synopsis }}" name="synopsis" id="synopsis">
                        @error('synopsis')
                            <small id="helpId" class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control shadow-none  @error('author') is-invalid @enderror"
                            value="{{ $book->author }}" name="author" id="author">
                        @error('author')
                            <small id="helpId" class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                            class="form-control shadow-none  @error('publisher') is-invalid @enderror"
                            value="{{ $book->publisher }}" name="publisher" id="publisher">
                        @error('publisher')
                            <small id="helpId" class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date"
                            class="form-control shadow-none  @error('publishingDate') is-invalid @enderror"
                            value="{{ $book->publishingDate }}" name="publishingDate" id="publishingDate">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                            class="form-control shadow-none  @error('illustrator') is-invalid @enderror"
                            value="{{ $book->illustrator }}" name="illustrator" id="illustrator">
                        @error('illustrator')
                            <small id="helpId" class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number"
                            class="form-control shadow-none  @error('totalPages') is-invalid @enderror"
                            value="{{ $book->totalPages }}" name="totalPages" id="totalPages">
                        @error('totalPages')
                            <small id="helpId" class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        <input type="hidden"
                            ...
                            value="{{ $book->quantity }}" name="quantity" id="quantity">
                    </div>

                    <div class="mb-3">
                        <label for="file" class="form-label">Image</label>
                        <input type="file" class="form-control shadow-none  @error('file') is-invalid @enderror"
                            onchange="previewFile(this)" name="file">
            ...
            <div class="col-sm-9 offset-sm-3">
                ...
                <a href="{{ route('book.destroy', $book->id) }}" class="btn btn-danger float-end"
